...
<head>
    ...
    <title>Tuyển Dụng - HADES STUDIO</title>
    ...
    <link rel="stylesheet" href="${classpath}/frontend/accsents/rec.css">
...
<body>
   <jsp:include page="/WEB-INF/views/frontend/layout/header.jsp"></jsp:include>
    ...
    <!-- RECRUITMENT -->
    <h2>RECCUITMENT</h2>
    <div class="reccuitment">
        
        <div class="contentrec ">
            <div class="imgrec">
                <a href=""><img src="${classpath}/frontend/accsents/accsent/image/careers_1.webp" alt=""></a>
            </div>
            <div class="titlerec">MEDIA CREATIVE</div>
            <div class="textrec">MARKETING TEAM</div>
        </div>
        <div class="contentrec ">
            <div class="imgrec">
                <a href=""><img src="${classpath}/frontend/accsents/accsent/image/careers_2.webp" alt=""></a>
            </div>
            <div class="titlerec">VIDEO EDITOR TITOK</div>
            <div class="textrec">TIKTOK TEAM</div>
        </div>
        <div class="contentrec ">
            <div class="imgrec">
                <a href=""><img src="${classpath}/frontend/accsents/accsent/image//careers_3.webp" alt=""></a>
            </div>
            <div class="titlerec">CONTENT CREATER</div>
            <div class="textrec">TIKTOK TEAM</div>
        </div>
        <div class="contentrec ">
            <div class="imgrec">
                <a href=""><img src="${classpath}/frontend/accsents/accsent/image/careers_4.webp" alt=""></a>
            </div>
            <div class="titlerec">PRODUCT DESIGN</div>
            <div class="textrec">PRODUCT TEAM</div>
        </div>
    </div>
    ...
    <footer>
        ...
        <div class="footerres">
            ...
            <div class="content4 col4">
                ...
                <a href="">
                    <img src="${classpath}/frontend/accsents/accsent/image/logo_bct_img_3c1bf699d3004ef2887fee1c4eb20afd.webp" alt="">
                </a>
