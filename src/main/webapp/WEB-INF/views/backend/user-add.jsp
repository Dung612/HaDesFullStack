...
<head>
    ...
    <!-- Favicon icon -->
<link rel="shortcut icon" href="//theme.hstatic.net/1000306633/1000891824/14/favicon.png?v=587" type="image/png">.png">
    <title>${title }</title>
	                        		 		...
	                        		 		<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:select path="userCreateUser.id" class="form-control" id="userCreateUser">
			                                            <sf:options items="${listUser }" itemValue="id" itemLabel="username"></sf:options>
			                                        </sf:select>
                                        		</div>
	                                    	</div>
