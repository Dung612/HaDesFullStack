										...
										<div class="table-responsive">
											...
											<table id="zero_config"
												...
												<c:set var="totalSales" value="0" />
													<c:forEach var="saleOrder" items="${saleOders }"
														varStatus="loop">
														<tr>
															...
															<td><a
																href="${rootpath }list-detail/${saleOrder.code}/${saleOrder.id}"
																role="button" class="btn btn-primary">Detail</a>
															<td><a
																href="${rootpath }/admin/order/done-product/${saleOrder.id }"
																role="button" class="btn btn-primary">Done</a>
															<td><a
																href="${rootpath }/admin/order/delete-product/${saleOrder.id }"
